  ...
  return (
    <View style={styles.container}>
      <View style={styles.layoutNav}>
        <Text
          style={{ ...styles.textNav, color: explore ? "#CF833F" : "white" }}
          onPress={showExplore}
        >
          Explore
        </Text>
        <Text
          style={{ ...styles.textNav, color: newPost ? "#CF833F" : "white",   }}
          onPress={showNewPost}
        >
          New post
        </Text>
        ...
        renderItem={({ item }) => (
          <View style={styles.layout}>
            ...
            <View style={styles.bottom}>
              <View style={styles.reactionCon} onTouchStart={likePost}>
                <Image
                  source={
                    liked
                ...
                <Text
                  style={{
                    ...styles.text2,
                    color: liked ? "#FF0808" : "white",
                  }}
                >
                  {item.number_of_likes > 0 ? item.number_of_likes : 0}
                </Text>
              </View>
              <View style={styles.reactionCon}>
                <Image source={require("../assets/comment.png")} />
                <Text style={styles.text2}>300</Text>
              </View>
              <View style={styles.reactionCon}>
                <Image source={require("../assets/repost.png")} />
                <Text style={styles.text2}>300</Text>
              </View>
              <View style={styles.reactionCon}>
